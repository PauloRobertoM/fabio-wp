...
class Vitrines {
   ...
   public function vitrines_register_meta_boxes( $meta_boxes ) {
      $prefix = 'vitrines_';
      $meta_boxes[] = array(
         'id'         => "{$prefix}foto_desktop",
         'title'      => 'Foto da Vitrine Desktop',
         ...
         'fields'     => array(
            array(
               ...
               'type'             => 'image_advanced',
               'force_delete'     => false,
               'desc'             => 'Adicionar foto Desktop',
               'max_file_uploads' => 1,
            ),
         )
      );
      $meta_boxes[] = array(
         'id'         => "{$prefix}foto_mobile",
         'title'      => 'Foto da Vitrine Mobile',
         'post_types' => array( 'vitrines' ),
         'context'    => 'normal',
         'priority'   => 'high',
         'autosave'   => true,
